...
public class DateUtils {
    ...
    public static String convertString(String parttern, Date date) {
        if (StringUtils.isEmpty(parttern) || date == null) {
            return null;
        }
    ...
    public static SimpleDateFormat getDateFormat(String parttern) {
        ...
        SimpleDateFormat dateFormat = maps.get(parttern);
        if(dateFormat == null)
        {
            synchronized (maps) {
                if(dateFormat == null)
    ...
    public static Date formatDate(String dateString){
        SimpleDateFormat df = getDateFormat(TYPE_YYYY_MM_DD_HH_MM_SS);
        try {
    ...
    public static String parseDate(Date date,String parttern){
        SimpleDateFormat df = getDateFormat(parttern);

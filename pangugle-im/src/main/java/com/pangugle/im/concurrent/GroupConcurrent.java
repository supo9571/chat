...
public class GroupConcurrent {
	
	// 并发线程数
	public static int CONCURRENT_SIZE = 10;

	private static GroupConcurrent instance = null;

	private ExecutorService pool = null;

	public static GroupConcurrent getInstance() {
		if (instance == null)
			instance = new GroupConcurrent();
		return instance;
	}

	private GroupConcurrent() {
		initPool();
	}
